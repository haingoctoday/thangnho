 ...
 *
 */
class UserreviewFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'review' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'rating' => 1,
            'modified' => '2018-05-31 04:06:24',
            'created' => '2018-05-31 04:06:24'
        ],
    ];
}
