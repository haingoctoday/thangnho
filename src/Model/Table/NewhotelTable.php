 ...
 */
class NewhotelTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('namehotel', 'create')
            ->notEmpty('namehotel');
       ...
       //     ->notEmpty('hinhanh');
        ...
        $validator
            ->requirePresence('hinhanhnho', 'create')
            ->notEmpty('hinhanhnho');

        $validator
            ->requirePresence('thongtinhotel', 'create')
            ->notEmpty('thongtinhotel');

        $validator
            ->requirePresence('saohotel', 'create')
            ->notEmpty('saohotel');
