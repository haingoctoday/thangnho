...
<!-- <section class="features3 cid-qFgDOlg1g7" id="features3-0" data-rv-view="224"> -->
    ...
    <section class="features18 popup-btn-cards cid-qFh2kAGoAG" id="features18-11" data-rv-view="797">
 ...
 ?>" class="">
                <div class="card-wrapper row ">
                    ...
                    <div class="col-md-9 row ">
                        ...
                        <h4 class="card-title mbr-fonts-style display-7"><?= $hotel_hot_item['namehotel']?> </h4>
                        <span class="mbr-text mbr-fonts-style align-left display-7"><?= $hotel_hot_item['diachi']?></span>
                    </div>
                   <div class="col-md-3">
                        <div class=" text-right">
                         Form
                        <br>
                        <span class="card-title mbr-fonts-style display-6"><b>25</b> USD</span>
                        <br>
                        <span>lowest avg nightly room rate</span>

                        </div>
                    </div>
                     
                     <div class="row">
                      <p class="mbr-text mbr-fonts-style align-left display-6"><?= h($hotel_hot_item['mota'])?></p>
...
.typeahead__container{
  ...
  <style type="text/css" media="screen">
  .card-title.mbr-fonts-style.display-7 {
    color: #38a7c2;
    ...
    .card-title.mbr-fonts-style.display-6 {
    color: #38a7c2;
    font-family: Helvetica Neue Roman,Helvetica,Arial,sans-serif;
    font-size: 26px;
    font-weight: lighter!important;
