 ...
 <?php echo $this->Flash->render(); ?>
              <div class="row">
                ...
                <!-- </div> -->
                <!-- <div class="col-md-9"> -->
                  <span style="line-height: 71px;"><b>Admin Login</b></span>
                <!-- </div> -->
              </div>
               <form action="<?php echo $this->Url->build(array('controller' => 'users', 'action' => 'login')); ?>" method="post">
              <div class="row mt-twt">
                <input  type="email" name="email" required class="form-control p-1 login-font style-input-twt" placeholder="User Name">
                <input type="password" name="password"  required class="form-control p-1 login-font mt-twt style-input-twt" type="text" placeholder="Password">
              </div>
              <div class="row mt-twt">
              ...
              <div class="row mt-twt">
                <div class="col-md-6 text-left p-0 login-font login-color-hi"><a  href="<?php echo $this->Url->build('/forgotpass-admin'); ?>" >Forgot your password?</a></div>
