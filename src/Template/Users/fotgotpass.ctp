        ...
        <div class="row">
          <div class="col-lg-5 mx-auto box-login-twt">
            <div class="wrapper-box p-3">
              ...
              <form action="<?php echo $this->Url->build(array('controller' => 'Users', 'action' => 'fotgotpass')); ?>" method="post">
              ...
              <div class="row mt-twt">
                <div class="col-md-6 text-left p-0 login-font login-color-hi"><a  href="<?php echo $this->Url->build('/index.html'); ?>" >Back to login</a></div>
