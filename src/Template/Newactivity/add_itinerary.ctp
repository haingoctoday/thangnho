...
<section class="content">
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <?= $this->Form->create($itinerary, array('role' => 'form')) ?>
          <div class="box-body">
        <input type="hidden" class="form-control" id="loai" name="loai" value="<?= $loai ?>">
  ...
  <div class="panel-body">
   ...
   <div class="expandable form-group" data-count="1">
    ...
    ?>
        <div class="row">
        <!--  <div class="hedat_in">Day 1</div> -->
          <div class="col-sm-6 nopadding">
              <div class="form-group">
                  <input type="text" class="form-control" id="name" name="name[]" value="<?php echo isset($id_drive)?$id_drive:''?>" placeholder="Name">
              </div>
          </div>
         <div class="col-sm-12 nopadding">
            <div class="form-group">
                <textarea rows="4" cols="50" class="form-control" name="mota[]"><?= isset($value_drive)?$value_drive:''?></textarea>
            </div>
