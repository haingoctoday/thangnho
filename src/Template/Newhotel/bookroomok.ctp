							...
							<tbody>
								...
								<tr class="<?php echo ($key%2)? 'odd' : 'even' ?>" >
									...
									<td class="id text-center">
										<span class="ico ico-hotel">&nbsp;</span>
										<span class="booking-item-id"> Hotel</span>
									</td>
									...
									<td class="details text-left">
										...
										<span class="place-region">Thành Phố Hội An, Vietnam</span>
						...
						<div class="form-button-property" style="padding-bottom: 19px;">
						    <div class="w-100 mx-auto">
						    	<div class="row">
                                        ...
                                        <input type="hidden" name="id_order" value="<?php $this->request->session()->read('Auth.User.id') ?>">
							        ...
							        <div class="border-nut-bookok mx-auto">
                                         <input type="checkbox" value="" id="terms_check">
