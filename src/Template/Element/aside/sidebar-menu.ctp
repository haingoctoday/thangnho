...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
           <li><a href="<?php echo $this->Url->build('/admin-activity'); ?>"><i class="fa fa-map"></i> Activity List</a></li>
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
             <li><a href="<?php echo $this->Url->build('/admin-agency-signup'); ?>"><i class="fa fa-map-signs"></i>Agency Sign-Up</a></li>
