    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title"><?= __('List of') ?> Address</h3>
          <div class="box-tools">
        ...
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            <tr>
              ...
              <th><?= $this->Paginator->sort('loai') ?></th>
              <th><?= __('Actions') ?></th>
            </tr>
            <?php foreach ($hoteldiachi as $hoteldiachi): ?>
              <tr>
                ...
                <td><?= $this->Number->format($hoteldiachi->status) ?></td>
                <td><?= h($hoteldiachi->loai) ?></td>
                <td class="actions" style="white-space:nowrap">
                  <?= $this->Html->link(__('View'), ['action' => 'view', $hoteldiachi->id], ['class'=>'btn btn-info btn-xs']) ?>
