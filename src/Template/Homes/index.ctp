<section class="engine"><a href="#">bootstrap slideshow</a></section><section class="cid-qESr5MAIF0 mbr-fullscreen mbr-parallax-background" id="header15-h" data-rv-view="303">
...
<div>THE WORLD
	...
	<h3 class="text-center pb-1" style="color: white;">CLIENT LOGIN</h3>
        <div class="media-container-column" data-form-type="formoid">
            ...
            <form class="mbr-form" action="#/" method="post" data-form-title="Mobirise Form"><input type="hidden" data-form-email="true" value="xb9ZST9zylh2ycgFrV0ndoEW7xJlg9U2vfxY16D2yaX0wR7E+zbkUznYx2MEn69FoNeeydTYTEdfCYTMj8x+sY3HPGTtX4KV7Iq0WUTQ/wQTWqBtBl4K0H/aqNvB/cmD">
                ...
                <div data-for="phone">
                    <div class="form-group">
                        <input type="tel" class="form-control px-3" name="phone" data-form-field="Phone" placeholder="Password" id="phone-header15-h">
                    </div>
                </div>
        ...
        <div class="container mb-5">
            <div class="media-container-row">
                <div class="col-12 align-center">
                    ...
                    <h3 class="mbr-section-subtitle mbr-light mbr-fonts-style display-5">Click any image to change it.Click blue "Gear" icon in the top right corner to change background, amount slides and amount visible items at once.</h3>
                </div>
            </div>
        </div>
