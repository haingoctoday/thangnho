...
<?php if($loai == 'cruise'){ ?>
                 <?php
                       echo ($data_post['destination'] == '1')? 'HaLong' : 'Mekong';
                  //   echo $session_search['destination'] ?> ,
                     <?php echo $data_post['formm'] ?> » 
                      <?php echo $data_post['to'] ?>
                          <?php }else{ ?>

                     <?php echo $data_post['destination'];?> ,
                     <?php echo $data_post['pick_up'] ?> » 
                      <?php echo $data_post['pick_off'] ?>
    <?php } ?>
                      </span>
                <span class="sub-title" style="text-transform:capitalize"><?php echo $destination ?></span>
                <div class="price-info">
                    <span style="font-size: 13px;">Total</span>
                    <span style="font-size: 30px;font-weight: 600;"><?php echo $sum_price * $tygia ?></span>
            ...
            <div class="col-md-3" style="background-color: #eee;">
                <div class="wrapper-about">
                    <div class="row bor-acti">
                        ...
                        <div class="col-md-6 detail"><?php echo $data_post['pickdate'] ?></div>
                    </div>
                    <div class="row bor-acti">
                        <div class="col-md-6 title">Destination</div>
                        <div class="col-md-6 detail"><?php echo $destination ?></div>
                    </div>
                    <div class="row bor-acti">
                            ...
                            <div class="w-100 mx-auto">
                                <div class="row">
                                     ...
                                     <input type="hidden" name="loai" value="<?php echo $loai ?>">
                                        <input type="hidden" name="sumprice" value="<?php echo $sum_price ?>">
